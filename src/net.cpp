...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Shurcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"shurcointools.com", "dnsseed.shurcointools.com"},
    {"shurcoinpool.org", "dnsseed.shurcoinpool.org"},
    {"xurious.com", "dnsseed.shur.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"shurcointools.com", "testnet-seed.shurcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Shurcoin is probably already running."), addrBind.ToString().c_str());
        else
